...
from workers import ArduinoWorker, CaenHvWorker # 이 부분이 수정되었습니다.
...
class WorkerManager(QObject):
    ...
    def stop_workers(self):
        self._arduino_worker.stop()
        self._caenhv_worker.stop()
        self._arduino_thread.quit()
        self._caenhv_thread.quit()
        self._arduino_thread.wait()
        self._caenhv_thread.wait()
